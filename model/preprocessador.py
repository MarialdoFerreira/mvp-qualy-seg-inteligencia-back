...
class PreProcessador:
    ...
    def preparar_form(self, form):
        ...
        X_input = pd.DataFrame([[form.idade,
                            form.sexo,
                            form.dependentes,
                            form.escolaridade,
                            form.estado_civil,
                            form.salario_anual,
                            form.tipo_cartao,
                            form.meses_de_relacionamento,
                            form.qtd_produtos,
                            form.iteracoes_12_meses,
                            form.meses_inativo_12_meses,
                            form.limite_de_credito,
                            form.valor_transacoes_12_meses,
                            form.qtd_transacoes_12_meses
                            ], [
                            form.idade, 
                            form.sexo,
                            form.dependentes,
    ...
    def scaler(self, X_train):
        """ Normaliza os dados. """
        # normalização/padronização
        scaler = pickle.load(open('./MachineLearning/scalers/minmax_scaler_credito.pkl', 'rb'))
